  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        {/* Nothing is done to an animal whose file is closed (RG5). */}
        {!isClosed && (
      ...
      <section className="mb-8 rounded-md border border-khulula-line bg-khulula-surface p-5">
        ...
        <p className="mt-4 text-sm">
          <span className="text-khulula-muted">Reason for admission: </span>
          {animal.admission_reason}
        </p>
        {animal.outcome_note && (
          <p className="mt-2 text-sm">
            <span className="text-khulula-muted">Outcome note: </span>
            {animal.outcome_note}
          </p>
        )}
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="text-sm">
          {animal.stays.map((stay) => (
            <li key={stay.id} className="border-b border-khulula-line py-2">
              ...
              {stay.move_reason && <span className="text-khulula-muted"> · {stay.move_reason}</span>}
            </li>
          ))}
        </ul>
      </section>
      ...
      <section>
        ...
        {isClosed ? (
          ...
          <form
            ...
            className="mb-6 flex flex-col gap-3 rounded-md border border-khulula-line bg-khulula-surface p-4"
          >
            {formError !== '' && (
        ...
        <ul>
          {animal.observations.map((observation) => (
            <li key={observation.id} className="border-b border-khulula-line py-3 text-sm">
